        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">Luxmart</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/pickup-points" className="text-gray-400 hover:text-white transition-colors">
                  Пункты выдачи
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/b2b" className="text-gray-400 hover:text-white transition-colors">
                  B2B
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 Luxmart. Все права защищены.
            </p>
